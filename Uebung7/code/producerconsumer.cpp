...
protected:
	ThreadSafeQueue<Item*> &queue_; // reference to the producer and the source of items
...
{
	ThreadSafeQueue<Item*> queue; // queue of items that are to be processed/consumed by worker thread
